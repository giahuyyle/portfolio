                ...
                <div>
                    <div className="max-w-3xl">
                            ...
                            <p className="mt-6 max-w-2xl text-base font-medium leading-8 tracking-tight text-(--hero-muted) sm:text-lg">
                                ...
                                ; based in Edmonton, AB. I&apos;m most comfortable building full-stack
                                applications mainly with{" "}
                                <a
                                    className="hero-link"
                                ...
                                , familiar with Django and FastAPI. I&apos;ve
                                also built basic web and mobile projects with
                                Java.
                            </p>
                    </div>
